...
export class Scanner {
  ...
  scanTokens(): Token[] {
    while (!this.isAtEnd()) {
      ...
      switch (c) {
        case "(":
          this.addTokenNullLiteral(TokenType.LEFT_PAREN);
          break;
        case ")":
          this.addTokenNullLiteral(TokenType.RIGHT_PAREN);
          break;
        case "{":
          this.addTokenNullLiteral(TokenType.LEFT_BRACE);
          break;
        case "}":
          this.addTokenNullLiteral(TokenType.RIGHT_BRACE);
          break;
        case ",":
          this.addTokenNullLiteral(TokenType.COMMA);
          break;
        case ".":
          this.addTokenNullLiteral(TokenType.DOT);
          break;
        case "-":
          this.addTokenNullLiteral(TokenType.MINUS);
          break;
        case "+":
          this.addTokenNullLiteral(TokenType.PLUS);
          break;
        case ";":
  ...
  tokenizeString() {
    ...
    this.addToken(
      TokenType.STRING,
      this.source.slice(this.start + 1, this.next - 1),
    );
    return;
  }
  ...
  tokenizeNumber() {
    ...
    this.addToken(
      TokenType.NUMBER,
      Number(this.source.slice(this.start, this.next)),
    );
  }
